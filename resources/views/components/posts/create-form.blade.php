  ...
  <div class="max-w-3xl px-4 py-8 mx-auto lg:py-14">
    ...
    <div class="mb-8">
      ...
      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
        Buat artikel baru untuk ditampilkan ke publik
      </p>
    </div>
    ...
    <form action="/dashboard" method="POST" id="post-form" enctype="multipart/form-data" class="space-y-10">
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
          PNG / JPG / JPEG — disarankan rasio 16:9
        </p>
        ...
        <div>
          ...
          >
            ...
            @foreach ($allCategory as $categories)
              <option value="{{ $categories->id }}" @selected(old('category_id') == $categories->id)>
                {{ $categories->name }}
              </option>
            @endforeach
          </select>
      ...
      <div class="space-y-4">
        ...
        <div id="editor" class="bg-white dark:bg-gray-700 rounded-lg min-h-50"></div>
